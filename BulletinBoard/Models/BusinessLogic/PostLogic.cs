...
public class PostLogic : IPostLogic
{
    ...
    {
        var query = from p in _unitOfWork.PostRepository.GetDbSet() where p.Id == postId
    ...
    {
        var query = from r in _unitOfWork.ReplyRepository.GetDbSet() where r.PostId == postId
